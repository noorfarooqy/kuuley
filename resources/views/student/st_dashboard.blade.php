                ...
                <div class="card">
                    <div class="card-header card-header-large bg-white d-flex align-items-center">
                        ...
                        <div class=" flatpickr-wrapper flatpickr-calendar-right d-flex ml-auto">
                            <div data-toggle="flatpickr" data-flatpickr-wrap="true" data-flatpickr-static="true" data-flatpickr-mode="range" data-flatpickr-alt-format="d/m/Y" data-flatpickr-date-format="d/m/Y">
                                <a href="javascript:void(0)" class="link-date" data-toggle=""> {{gmdate('d/m/Y', time()-24*60*60*720)}} <span class="text-muted mx-1">to</span> {{gmdate('d/m/Y', time())}}</a>
                    ...
                    <div class="list-group tab-content list-group-flush">
                        <div class="tab-pane active show fade" id="activity_all">
                            ...
                            {{-- <div class="list-group-item list-group-item-action d-flex align-items-center ">
                                <div class="avatar avatar-xs mr-3">
                                    <span class="avatar-title rounded-circle bg-primary">
                                        <img src="assets/images/logo.svg" alt="avatar" width="20">
                                    </span>
                                </div>
                            ...
                            <div class="list-group-item list-group-item-action flex-design-items-center">
                                No activity
                            </div>


                            <div class="card-footer text-center border-0">
                                <a class="text-muted" href="">View All (0)</a>
                            </div>
                        </div>
