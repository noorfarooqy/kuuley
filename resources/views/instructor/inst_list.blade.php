                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="js-lists-values-employee-name">
                                            {{$instructor->inst_firstname.' '.$instructor->inst_secondname}}
                                        </span>
    
                                    </td>
    
    
                                    <td><span class="badge badge-warning">{{$instructor->inst_is_active == 0 ? "Inactive": "Active"}}</span></td>
                                    <td><small class="text-muted">{{$instructor->UserInfo->email}}</small></td>
                                    <td><small class="text-muted">{{$instructor->inst_telephone}}</small></td>
                                    <td class="dropdown">
                                        <div href="#"  class="text-muted" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="material-icons">more_vert</i>
                                        </div>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="/admin/accounts/inst/{{$instructor->id}}" target="_blank">View profile</a>
                                          </div>
