        ...
        <div class="card card-body">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        <input name="password_confirmation" type="password" required="" class="form-control form-control-prepended" placeholder="Enter your password">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <span class="fa fa-key"></span>
                            </div>
                ...
                <div class="form-group mb-1">
                    <p>
                        By clicking on register you agree to the <a href="">Terms and Conditions</a>
                        and <a href="">Privacy policy</a> set for all users
                    </p>
                </div>
                <div class="form-group mb-1">
                ...
                <div class="form-group text-center mb-0">
                    Already have an account? <a class="text-underline" href="/login">Sign In</a>
                </div>
            </form>
        </div>
    </div>
