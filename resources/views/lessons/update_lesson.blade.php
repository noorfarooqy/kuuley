    ...
    <div class="container-fluid page__container">
        <div class="row">
            <div class="col-md-8">
                ...
                <form action="/admin/courses/{{$course->id}}/lessons/{{$lesson->id}}/update" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        <div class="card-form__body card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <select class="form-control" id="" name="lessonSection">
                                        ...
                                        @if (old('lessonSection') == $section->id || $lesson->lessonSection->id == $section->id)
                                ...
                                <div class="col-md-8 col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <input name="lessonTitle" type="text" class="form-control"
                                            ...
                                            value="{{old('lessonTitle') != null ? old('lessonTitle') : $lesson->lessonTitle}}">
                                    </div>
                                </div>
                                <div class="col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select name="lessonType" id="" class="form-control"
                                            ...
                                            @if (old('lessonType') == 2 || $lesson->lesson_type <= $lesson->lesson_document)
                                            <option selected value="2">Normal lesson</option>
                                            <option value="1">Assignment</option>
                                            @elseif (old('lessonType') == 1 || $lesson->lesson_type == $lesson->lesson_assignment)
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="lessonDescription" rows="4" class="form-control"
                                    placeholder="Please enter a description">{{old('lessonDescription') != null ? old('lessonDescription') : $lesson->lessonDescription}}</textarea>
                            </div>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <div class="custom-control custom-checkbox-toggle custom-control-inline mr-1">
                                    ...
                                    @else
                                    <input name="lessonIsPublished" type="checkbox" id="subscribe"
                                        class="custom-control-input">    
                                    @endif
                    ...
                    @if ($lesson->lesson_type >= $lesson->lesson_assignment)
                    ...
                    <div v-else-if="lessonType == null">
                        <input type="text"  disabled value="{{$lesson->Assignment->quiz_title}}" class="form-control">
