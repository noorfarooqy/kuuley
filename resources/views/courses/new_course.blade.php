...
<div class="mdk-drawer-layout__content page" style="transform: translate3d(0px, 0px, 0px);">
    ...
    <div class="container-fluid page__container">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <form action="/admin/courses/new" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="card-form__body card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="courseName" type="text" class="form-control" placeholder="Title goes here" value="{{old('courseName')}}">
                            </div>
                            @error('courseName')
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="courseDescription" rows="4" class="form-control" placeholder="Please enter a description">{{old('courseDescription')}}</textarea>
                            </div>
                                ...
                                <div class="dz-clickable media align-items-center" data-toggle="dropzone" data-dropzone-url="http://" data-dropzone-clickable=".dz-clickable" data-dropzone-files="[&quot;/assets/images/account-add-photo.svg&quot;]">
                                    <div class="dz-preview dz-file-preview dz-clickable mr-3">
                                        <div class="avatar avatar-lg dz-error dz-complete">
                                            <img src="/assets/images/account-add-photo.svg" id="coursePreview" class="avatar-img rounded" alt="..." data-dz-thumbnail="">
                                        </div>
                                    </div>
