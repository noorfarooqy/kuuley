...
<div class="container-fluid page__container mt-4 mb-4" v-if="Course != null">
    <div class="row" style="height: 400px;">
        <div class="col-md-4 ps" data-perfect-scrollbar="">
            ...
            <ul class="list-group list-group-fit" style="overflow-y: scroll;max-height: 300px;" 
            v-for="(section , skey) in Course.lesson_sections" :key="skey">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header card-header-large bg-light d-flex align-items-center">
                    ...
                    <div class="ml-auto">
                        <a href="#" class="btn btn-light text-muted"><i
